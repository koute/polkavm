...
impl<V> RangeMap<V> {
    ...
    pub fn remove(&mut self, key: Range<u64>) -> RemoveIter<V>
    where
        V: Clone,
    {
...
fn test_overlapping_two() {
    ...
    map.insert(4..30, 0);
    map.insert(8..20, 1);
    assert_eq!(map.clone().into_vec(), vec![((4..8), 0), ((8..20), 1), ((20..30), 0),]);

    map.insert(4..16, 2);
    assert_eq!(map.into_vec(), vec![((4..16), 2), ((16..20), 1), ((20..30), 0),]);
}
...
fn test_case_1() {
    ...
    assert_eq!(map.into_vec(), vec![((0..1), 2), ((1..8), 0), ((8..18), 3),]);
}
