...
use polkavm::{Caller, Config, Engine, CallError, Instance, Linker, Module, ModuleConfig, ProgramBlob};
    ...
    pub fn from_blob(blob: ProgramBlob) -> Result<Self, polkavm::Error> {
        ...
        linker.define_typed(
            ...
            |caller: Caller<State>, address: u32, width: u32, height: u32| -> Result<(), Error> {
                ...
                caller.instance.read_memory_into(address, &mut caller.user_data.frame.spare_capacity_mut()[..length as usize])?;
                unsafe {
        ...
        linker.define_typed(
            ...
            |caller: Caller<State>, address: u32, samples: u32| -> Result<(), Error> {
                ...
                {
                    let audio_buffer: &mut [MaybeUninit<i16>] = &mut caller.user_data.audio_buffer.spare_capacity_mut()[..samples as usize * 2];
