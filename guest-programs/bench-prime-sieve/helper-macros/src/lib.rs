...
/// for instance.
fn substitute_placeholder(ts: proc_macro2::TokenStream, substitute_value: usize) -> proc_macro2::TokenStream {
    ts.into_iter()
        .map(|tt| {
            match tt {
                TokenTree::Ident(id) => {
...
fn extreme_reset_word(slice_expr: proc_macro2::TokenStream, skip: usize, word_idx: usize) -> proc_macro2::TokenStream {
